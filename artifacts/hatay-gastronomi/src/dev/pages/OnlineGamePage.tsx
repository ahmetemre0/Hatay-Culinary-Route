...
function ChatPanel() {
  ...
  return (
    <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 flex flex-col overflow-hidden" style={{ maxHeight: "360px" }}>
      <div className="text-white/50 text-[10px] uppercase tracking-wider px-3 pt-2.5 pb-1 shrink-0">
        💬 Sohbet
      </div>

      <div className="flex-1 overflow-y-auto px-3 pb-2 flex flex-col gap-1 min-h-0" style={{ maxHeight: "280px" }}>
