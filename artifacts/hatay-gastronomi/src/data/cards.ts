...
const REGION_TEMPLATES: Omit<RegionCard, "id" | "type">[] = [
  {
    ...
    district: "Antakya",
    dish: "Tepsi Kebabı",
    requiredMaterials: ["Et", "Sebze", "Ates"],
    points: 10,
    emoji: "🍖",
  ...
  },
  {
    ...
    district: "İskenderun",
    dish: "Döner",
    requiredMaterials: ["Et", "Ekmek", "Sos"],
    points: 8,
    emoji: "🥙",
  ...
  },
  {
    ...
    district: "Samandağ",
    dish: "Humus",
    requiredMaterials: ["Nohut", "Nohut", "Zeytinyagi"],
    points: 7,
    emoji: "🫘",
  ...
  },
  {
    name: "Altınözü",
    district: "Altınözü",
    dish: "Zeytin Salatası",
    requiredMaterials: ["Zeytinyagi", "NarEksisi", "Sebze"],
    points: 6,
    emoji: "🫒",
  ...
  },
  {
    ...
    district: "Yayladağı",
    dish: "Lokum",
    requiredMaterials: ["Seker", "Meyve", "Seker"],
    points: 5,
    emoji: "🍬",
  ...
  },
  {
    ...
    district: "Kırıkhan",
    dish: "Tatlı Kavun",
    requiredMaterials: ["Meyve", "Meyve", "Seker"],
    points: 4,
    emoji: "🍈",
  ...
  },
  {
    ...
    district: "Arsuz",
    dish: "Balık Ekmeği",
    requiredMaterials: ["Sebze", "Ekmek", "Sos"],
    points: 8,
    emoji: "🐟",
  ...
  },
  {
    name: "Dörtyol",
    district: "Dörtyol",
    dish: "Narenciye Tabağı",
    requiredMaterials: ["Meyve", "Meyve"],
    points: 3,
    emoji: "🍊",
  ...
  },
  {
    ...
    district: "Belen",
    dish: "Tava",
    requiredMaterials: ["Et", "Ates", "Zeytinyagi"],
    points: 9,
    emoji: "🍳",
...
function buildRegionDeck(): RegionCard[] {
  const deck: RegionCard[] = [];
  let idx = 0;
  for (const tmpl of REGION_TEMPLATES) {
    const count = COUNTS[tmpl.district] ?? 1;
    for (let i = 0; i < count; i++) {
      deck.push({ ...tmpl, id: `region-${idx++}`, type: "region" });
    }
  }
  return deck;
}
...
const MATERIAL_TEMPLATES: { materialType: MaterialType; name: string; emoji: string; color: string; count: number }[] = [
  ...
  { materialType: "Zeytinyagi", name: "Zeytinyağı / Zeytin", emoji: "🫙", color: "from-olive-400 to-green-700", count: 6 },
...
const EVENT_TEMPLATES: Omit<EventCard, "id" | "type">[] = [
  {
    effectName: "Samandağ Biberi",
    description: "Bir rakibin bu turki atlamasına neden ol!",
    action: "skip_turn",
    emoji: "🌶️",
    color: "from-red-600 to-red-800",
  },
  {
    effectName: "Asi Nehri Taştı",
    description: "Herkes elindeki tüm kartları desteye koyup yeniden çeker.",
    action: "reshuffle_all",
    emoji: "🌊",
    color: "from-blue-400 to-blue-700",
  },
  {
    effectName: "Misafirperverlik",
    description: "Bir rakibinden rastgele 1 kart çek.",
    action: "steal_card",
    emoji: "🤝",
    color: "from-teal-400 to-teal-600",
  },
  {
    effectName: "Bereketli Topraklar",
    description: "Desteden fazladan 2 kart çek.",
    action: "draw_two",
    emoji: "🌿",
    color: "from-green-500 to-green-700",
  },
  {
    effectName: "Esnaf Dayanışması",
    description: "Başka bir oyuncuyla elindeki 2 kartı açıkça takas et.",
    action: "trade_two",
    emoji: "🏪",
    color: "from-yellow-500 to-yellow-700",
  },
  {
    effectName: "Sıcak Hava Dalgası",
    description: "Tüm oyuncular bir sonraki tur bölge tamamlayamaz.",
    action: "block_region",
    emoji: "☀️",
    color: "from-orange-400 to-yellow-500",
  },
  {
    effectName: "Künefe Şöleni",
    description: "Önündeki bir bölgenin puanını 2 ile çarp!",
...
const EVENT_COUNTS: Record<string, number> = {
  ...
  "Asi Nehri Taştı": 3,
  Misafirperverlik: 3,
  "Bereketli Topraklar": 3,
  "Esnaf Dayanışması": 3,
  "Sıcak Hava Dalgası": 2,
  "Künefe Şöleni": 2,
};
...
export function buildInitialDecks() {
  const regionDeck = shuffle(buildRegionDeck());
  const materialEventDeck = shuffle([...buildMaterialDeck(), ...buildEventDeck()]);
  return { regionDeck, materialEventDeck };
}
