export type MaterialType =
  ...
  | "Tahin" | "Peynir" | "Dondurma" | "Patates" | "Bulgur"
  | "Joker";
...
const MATERIAL_TEMPLATES: { materialType: MaterialType; name: string; emoji: string; color: string; count: number }[] = [
  { materialType: "Et", name: "Et", emoji: "🥩", color: "from-red-400 to-red-600", count: 9 },
  { materialType: "Sebze", name: "Sebze", emoji: "🥦", color: "from-green-400 to-green-600", count: 9 },
  { materialType: "Ekmek", name: "Ekmek", emoji: "🫓", color: "from-yellow-300 to-yellow-500", count: 6 },
  { materialType: "ZeytinYagi", name: "Zeytin Yağı", emoji: "🫙", color: "from-lime-500 to-green-700", count: 8 },
  { materialType: "Ates", name: "Ateş", emoji: "🔥", color: "from-orange-400 to-red-500", count: 6 },
  { materialType: "Nohut", name: "Nohut", emoji: "🫛", color: "from-amber-300 to-amber-500", count: 2 },
  { materialType: "NarEksisi", name: "Nar Ekşisi", emoji: "🍷", color: "from-purple-400 to-purple-600", count: 3 },
  { materialType: "Seker", name: "Şeker", emoji: "🍚", color: "from-pink-200 to-pink-400", count: 5 },
  { materialType: "Meyve", name: "Meyve", emoji: "🍎", color: "from-red-300 to-orange-400", count: 3 },
  { materialType: "Sos", name: "Sos", emoji: "🌶️", color: "from-red-500 to-red-700", count: 4 },
  ...
  { materialType: "Patates", name: "Patates", emoji: "🥔", color: "from-amber-300 to-amber-500", count: 2 },
  { materialType: "Bulgur", name: "Bulgur", emoji: "🌾", color: "from-stone-400 to-stone-600", count: 5 },
  { materialType: "Joker", name: "Vakıflı Sepeti (Joker)", emoji: "🧺", color: "from-violet-400 to-violet-600", count: 5 },
];
...
const EVENT_TEMPLATES: Omit<EventCard, "id" | "type">[] = [
  ...
  { effectName: "Saray Caddesine Taşındık", description: "Yemekler değer kazandı. Sipariş penceresindeki bir yemeğin puanını 2 ile çarp!", action: "multiply_points", emoji: "🏰", color: "from-amber-400 to-amber-600" },
...
const EVENT_COUNTS: Record<string, number> = {
  ...
  "Asi Nehri Taştı": 2,
  Misafirperverlik: 5,
  "Bereketli Topraklar": 5,
  "Esnaf Dayanışması": 4,
  "Sıcak Hava Dalgası": 3,
  "Saray Caddesine Taşındık": 2,
  "Memleket Hasreti": 2,
  Etobur: 2,
