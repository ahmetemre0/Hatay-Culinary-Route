...
const FOOD_TEMPLATES: Omit<FoodCard, "id" | "type">[] = [
  { name: "Sürki", requiredMaterials: ["ZeytinYagi", "Peynir"], points: 4, emoji: "🧀", color: "from-yellow-400 to-amber-600" },
  ...
  { name: "Harbiye Kebap", requiredMaterials: ["Et", "Sebze", "Ekmek"], points: 6, emoji: "🍖", color: "from-red-600 to-red-800" },
  ...
  { name: "Katıklı", requiredMaterials: ["Ekmek", "Ates", "Peynir"], points: 7, emoji: "🫙", color: "from-slate-400 to-slate-600" },
  ...
  { name: "Künefe", requiredMaterials: ["Seker", "Peynir", "Dondurma"], points: 10, emoji: "🍯", color: "from-amber-300 to-amber-500" },
  { name: "Fellah Köftesi", requiredMaterials: ["Sebze", "Sos", "Bakliyat"], points: 6, emoji: "🫕", color: "from-red-500 to-red-700" },
  { name: "Belen Tava", requiredMaterials: ["Et", "Sebze", "Ates"], points: 5, emoji: "🍳", color: "from-orange-600 to-red-700" },
  { name: "Kağıt Kebabı", requiredMaterials: ["Et", "Sebze", "Ekmek", "Ates"], points: 8, emoji: "📜", color: "from-red-600 to-amber-700" },
  { name: "Tepsi Kebabı", requiredMaterials: ["Et", "Sebze", "Ates", "Sos"], points: 9, emoji: "🥘", color: "from-red-700 to-red-900" },
  { name: "Hatay Döner", requiredMaterials: ["Et", "Ekmek", "Sos", "Sebze"], points: 9, emoji: "🥙", color: "from-orange-600 to-red-800" },
